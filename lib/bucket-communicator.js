...
exports.upload = function (uploadables, options, done) {
  ...
  var promises = uploadables.map(function (uploadable) {
    return new Promise(function (resolve, reject) {
      storage.putFile(options, uploadable, function (err, data) {
